...
// Load Languages       //
//////////////////////////
// load_theme_textdomain('vp_textdomain', VP_DIR . '/lang'); //locked as theme text domain is in use
...
{
	function _vp_post_dummy_editor_filter()
	{
		return 'tinymce';
	}
	...
	function vp_post_dummy_editor()
	{
		...
		if( $dummy )
		{
			...
			add_filter( 'wp_default_editor', '_vp_post_dummy_editor_filter' );
