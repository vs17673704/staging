...
class VP_ShortcodeGenerator
{
	...
	function print_form($attributes)
	{
		...
		<div class="vp-sc-action">
			<button class="vp-sc-insert button"><?php esc_html_e('Insert', 'adventure-tours'); ?></button>
			<button class="vp-sc-cancel button"><?php esc_html_e('Cancel', 'adventure-tours') ?></button>
		</div>
		<?php
	}
