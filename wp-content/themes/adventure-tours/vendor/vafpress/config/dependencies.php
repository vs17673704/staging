...
return array(
	...
	'scripts' => array(
		...
		'paths' => array(
			...
			'select2' => array(
				...
				'deps'     => array('jquery'),
				'ver'      => '4.0.3',
				// 'path'     => VP_PUBLIC_URL . '/js/vendor/select2-v3.3.2.min.js', 'ver' => '3.3.2',
				'override' => true,
			),
	...
	'styles' => array(
		...
		'paths' => array(
			...
			'select2' => array(
				'path' => VP_PUBLIC_URL . '/css/vendor/select2.min.css', // v4.0.3
				// 'path' => VP_PUBLIC_URL . '/css/vendor/select2-v3.3.2.css',
				'deps' => array(),
			),
			'reveal' => array(
