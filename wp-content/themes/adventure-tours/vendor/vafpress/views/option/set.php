<div class="wrap">
	...
	<div id="vp-wrap" class="vp-wrap">
			...
			<div class="vp-right-panel">
				<form id="vp-option-form" class="vp-option-form vp-js-option-form" method="POST">
					<div id="vp-submit-top" class="vp-submit top">
						<div class="inner">
							<input class="vp-save vp-button button button-primary" type="submit" value="<?php esc_attr_e('Save Changes', 'adventure-tours'); ?>" />
							<p class="vp-js-save-loader save-loader" style="display: none;"><img src="<?php VP_Util_Res::img_out('ajax-loader.gif', ''); ?>" /><?php esc_html_e('Saving Now', 'adventure-tours'); ?></p>
		...
		<div id="vp-copyright" class="vp-copyright">
			<p><?php printf( esc_html__( 'This option panel is built using', 'adventure-tours' ) . ' <a href="http://vafpress.com/vafpress-framework">' . esc_html__( 'Vafpress Framework', 'adventure-tours' ) . ' %s</a> ' . esc_html__( 'powered by' , 'adventure-tours' ) . ' <a href="http://vafpress.com">Vafpress</a>', VP_VERSION); ?></p>
		</div>
	</div>
</div>